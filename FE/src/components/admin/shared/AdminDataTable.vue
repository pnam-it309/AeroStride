            ...
            <template v-else>
              ...
              >
                <td
                  v-for="col in columns"
                  :key="col.key"
                  class="px-6 py-5 text-sm text-gray-700 font-bold"
                >
                ...
                <td class="px-6 py-5 text-right">
                  ...
                  >
                    <button class="text-xs font-black text-aurora hover:underline uppercase">
                      Edit
                    </button>
                    <button class="text-xs font-black text-gray-400 hover:text-red-500 uppercase">
                      Rev
                    </button>
                  </div>
                </td>
