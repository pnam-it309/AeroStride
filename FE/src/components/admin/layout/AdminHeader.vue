...
<template>
  <header
    class="h-24 border-b border-gray-100 flex items-center justify-between px-10 z-40 bg-white/80 backdrop-blur-md sticky top-0"
  >
    <div class="flex items-center gap-6">
      ...
      <div class="flex flex-col">
        <h2
          class="text-2xl font-black font-display text-gray-900 uppercase tracking-tighter italic leading-none"
        >
    ...
    <div class="flex items-center gap-8">
      ...
      <div class="flex items-center gap-4 pl-8 border-l border-gray-100">
        ...
        <div
          class="w-12 h-12 rounded-2xl bg-aurora/10 border border-aurora/20 flex items-center justify-center overflow-hidden shadow-sm"
        >
