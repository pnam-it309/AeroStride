    ...
    <v-container fluid class="pa-6 bg-grey-lighten-4 min-h-screen">
        ...
        <div class="d-flex align-center justify-space-between mb-6">
            ...
            <div class="d-flex gap-3">
                <v-btn variant="outlined" color="#2E4E8E" class="text-none font-weight-bold px-6 rounded-lg" prepend-icon="mdi-printer">
                    In hóa đơn
                </v-btn>
                        ...
                        <tbody>
                            <tr v-for="item in order.listsHoaDonChiTiet" :key="item.id">
                                <td class="py-4">
                                    <div class="d-flex align-center">
                                        <div
                                            class="rounded-lg border bg-grey-lighten-4 mr-4 d-flex align-center justify-center p-2"
                                        ...
                                        <div>
                                            ...
                                            <div class="text-caption text-grey">
                                                Màu: {{ item.tenMauSac }} | Size: {{ item.tenKichThuoc }}
                                            </div>
                                        </div>
                                    </div>
                                </td>
                    ...
                    <div class="pa-6 d-flex flex-column align-end bg-grey-lighten-5">
                        ...
                        <div class="d-flex justify-space-between mb-2 text-error" style="width: 250px">
                            ...
                            <span class="font-weight-bold"
                                >- {{ formatCurrency(order.tongTien - (order.tongTienSauGiam || order.tongTien)) }}</span
                            >
                        </div>
                        <div class="d-flex justify-space-between mb-2" style="width: 250px">
            ...
            <v-col cols="12" lg="4">
                ...
                <v-card class="rounded-xl border shadow-none mb-6">
                    ...
                    <v-card-text class="pa-6">
                        ...
                        <div class="d-flex align-center mb-4">
                            <v-chip variant="tonal" color="#2E4E8E" class="font-weight-bold">
                        ...
                        <div class="text-body-2 text-slate-600 mb-4">
                            {{ order.ngayDuKienNhan ? formatDate(order.ngayDuKienNhan) : 'Chưa cập nhật' }}
                        </div>
        ...
        <div v-else-if="loading" class="d-flex flex-column align-center justify-center py-16">
            <v-progress-circular indeterminate color="#2E4E8E" size="64"></v-progress-circular>
