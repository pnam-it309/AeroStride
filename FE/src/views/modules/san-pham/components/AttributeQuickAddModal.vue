...
<template>
    <v-dialog :model-value="show" @update:model-value="emit('update:show', $event)" max-width="450" scrollable
        ...
        <v-card class="rounded-xl overflow-hidden">
            ...
            <v-card-text class="pa-6">
                <v-row>
                    ...
                    <v-col cols="12">
                        ...
                        <v-textarea v-model="form.moTa" placeholder="Nhập mô tả..." variant="outlined" rows="2"
            ...
            <v-card-actions class="pa-6 pt-2 bg-slate-50 border-t d-flex justify-end gap-2">
                <v-btn variant="tonal" color="slate-400" @click="emit('update:show', false)"
                    class="rounded-lg font-weight-bold">Hủy</v-btn>
