                    ...
                    <v-row class="variant-modal-layout">
                        <v-col cols="12" md="4">
                            <div class="form-group h-100">
                                ...
                                <div class="variant-image-panel h-100">
                                    <div class="variant-image-panel__preview">
                                        <v-avatar rounded="xl" size="260" class="bg-slate-50">
                                    ...
                                    <div class="variant-image-panel__body d-flex flex-column align-center mt-4">
                                        <input type="file" ref="fileInput" class="d-none" accept="image/*"
                                            @change="handleImageUpload" />

                                        <div v-if="allowImageUpload" class="d-flex flex-wrap justify-center gap-2">
                                            <v-btn variant="flat" color="primary"
                                                class="rounded-xl font-weight-black text-none px-8 h-11 text-white" :loading="uploadingImage"
                                                @click="triggerFileInput">
                                                <PlusIcon size="18" class="mr-2 text-white" /> Chọn ảnh
                                            </v-btn>
                                            <v-btn v-if="formData.urlAnh" variant="tonal" color="error"
                                                class="rounded-xl text-none px-4 h-11" @click="formData.urlAnh = ''">
                                                <TrashIcon size="18" />
                                            </v-btn>
                                        </div>
