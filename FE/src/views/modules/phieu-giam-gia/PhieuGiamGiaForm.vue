...
import { ChevronLeftIcon, DeviceFloppyIcon, TicketIcon, SettingsIcon, InfoCircleIcon, CalendarIcon } from 'vue-tabler-icons';
                        ...
                        <v-row>
                            <v-col cols="12" md="6">
                                <div class="text-subtitle-2 font-weight-bold mb-1 ml-1 text-dark">
                                    Mã Voucher *
                                    <span class="text-caption text-#2E4E8E" v-if="!isEditMode && !isDetailView"
                                        >(Tự động sinh nếu trống)</span
                                    >
                                </div>
                                <v-text-field
                                    v-model="form.ma"
                            ...
                            <v-col cols="12" v-if="form.loaiHienThi === 'CA_NHAN'">
                                ...
                                >
                                    <template #item="{ props, item }">
                                        <v-list-item
                                            v-bind="props"
                                            :subtitle="`${item.raw.sdt || ''} - ${item.raw.email || ''}`"
                                        ></v-list-item>
                                    </template>
                                </v-autocomplete>
                            </v-col>
                ...
                <v-card class="rounded-xl border shadow-none">
                    ...
                    <v-card-text class="pa-6">
                        <v-row>
                            ...
                            <v-col cols="12" md="6">
                                <div class="text-subtitle-2 font-weight-bold mb-1 ml-1 text-dark">
                                    {{ form.loaiPhieu === 'PHAN_TRAM' ? 'Giá trị giảm (%) *' : 'Số tiền giảm (₫) *' }}
                                </div>
                                <v-text-field
                    ...
                    <v-card-text class="pa-6">
                        <v-select
                            ...
                            :items="[
                                ...
                                { title: 'Tạm ngưng', value: 'KHONG_HOAT_DONG' }
                            ]"
                            variant="outlined"
                            density="comfortable"
                            hide-details
                        >
                            <template #selection="{ item }">
                                <v-chip
                                    :color="item.value === 'DANG_HOAT_DONG' ? 'success' : 'error'"
                                    variant="flat"
                                    size="small"
