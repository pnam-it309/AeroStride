                        ...
                        <v-row>
                            <v-col cols="12" md="4">
                                ...
                                <v-text-field
                                    v-model="form.ma"
                                    readonly
                                    :placeholder="isEditMode ? '' : 'Hệ thống tự sinh khi lưu'"
                                    variant="outlined"
                                    density="compact"
                            ...
                            <v-col cols="12" md="8">
                                ...
                                <v-text-field
                                    v-model="form.ten"
                                    :readonly="isViewOnly"
                                    placeholder="Ví dụ: Voucher Mừng Sinh Nhật..."
                                    variant="outlined"
                                    density="compact"
                                    hide-details
                                ></v-text-field>
                            ...
                            <v-col cols="12">
                                ...
                                <v-textarea
                                    ...
                                    variant="outlined"
                                    rows="3"
                                    placeholder="Điều kiện chương trình..."
                                    hide-details
                        ...
                        <v-row>
                            ...
                            <v-col cols="12" md="4">
                                ...
                                <v-text-field
                                    ...
                                    density="compact"
                                    hide-details
                                    :class="form.loaiPhieu === 'TIEN_MAT' ? 'bg-slate-50' : ''"
                                ></v-text-field>
                            </v-col>
                            <v-col cols="12" md="6">
                                <div class="d-flex align-center gap-4 mb-2" style="height: 24px">
                                    ...
                                    <v-switch
                                        v-model="isInfinite"
                                        :disabled="isViewOnly || form.loaiHienThi === 'CA_NHAN'"
                                        label="Vô hạn"
                                        color="primary"
                                        density="compact"
                                        hide-details
                                        class="custom-mini-switch ml-2"
                                    ></v-switch>
                                </div>
                                <v-text-field
                                    ...
                                    :disabled="isInfinite || isViewOnly || form.loaiHienThi === 'CA_NHAN'"
                                    variant="outlined"
                                    density="compact"
                                    hide-details
                                ></v-text-field>
                            ...
                            <v-col cols="12" md="6">
                                ...
                                <v-text-field
                                    v-model="formattedGiatriToiThieu"
                                    :readonly="isViewOnly"
                                    type="text"
                                    placeholder="0"
                                    variant="outlined"
