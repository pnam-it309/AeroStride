    ...
    <v-container fluid class="pa-4 animate-fade-in font-body admin-module-page">
        ...
        >
            ...
            >
                <template #row="{ item, index }">
                    <tr class="data-row">
                        <td class="data-cell text-center text-black font-weight-medium" style="font-size: 13px !important">
                        ...
                        <td class="data-cell text-left px-4" style="font-size: 13px !important">
                            <div class="d-flex flex-column gap-1" style="word-break: break-word; white-space: normal">
                                <div
                                    v-for="(variant, idx) in item.bienThes"
                                    :key="idx"
                                ...
                                <span
                                    v-if="!item.bienThes || item.bienThes.length === 0"
                                    class="text-slate-400 italic"
                                    style="font-size: 13px !important"
                                    >Không có sản phẩm</span
                                >
                            </div>
                        </td>
                        <td
                            class="data-cell text-left px-4 text-slate-800"
                        ...
                        <td class="data-cell text-left px-4" style="font-size: 13px !important">
                            <div class="d-flex flex-column" style="word-break: break-word; white-space: normal">
                                <div v-if="item.soDienThoai" class="text-slate-700 mb-1" style="font-size: 13px !important">
                                    <v-icon size="14" class="mr-1 text-slate-400" style="font-size: 14px !important">mdi-phone</v-icon>
                                    {{ item.soDienThoai }}
                                </div>
                                <div v-if="item.diaChiNguoiNhan" class="text-slate-500 line-height-1-4" style="font-size: 13px !important">
                                    <v-icon size="14" class="mr-1 text-slate-400" style="font-size: 14px !important">mdi-map-marker</v-icon>
                                    {{ item.diaChiNguoiNhan }}
                                </div>
                                <div
                                    v-if="!item.soDienThoai && !item.diaChiNguoiNhan"
                        ...
                        <td class="data-cell text-center font-weight-bold" style="color: #1e257c !important; font-size: 13px !important">
                            ...
                            <div v-else class="px-8">
                                ...
                                >
                                    ...
                                    <div class="d-flex align-center gap-2 mb-2 text-slate-600">
                                        ...
                                        <span class="text-body-2 font-weight-medium" style="font-size: 14px !important">{{
                                            addr.sdtNguoiNhan
                                        }}</span>
                                    </div>
...
:deep(.v-field) {
    background-color: #f1f5f9 !important; /* soft light slate-100 */
...
:deep(.v-field__outline) {
    display: none !important; /* hide outline completely */
}
