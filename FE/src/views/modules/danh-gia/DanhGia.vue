...
const getStatusChip = (status) => {
    switch (status) {
        case 'APPROVED':
            return { color: 'success', text: 'Đã duyệt' };
        case 'REJECTED':
            return { color: 'error', text: 'Từ chối' };
        case 'SPAM':
            return { color: 'warning', text: 'Spam' };
        case 'PENDING':
        default:
            return { color: 'secondary', text: 'Chờ duyệt' };
    }
};
        ...
        >
            <v-col cols="12" md="6" lg="6" class="filter-cell">
                ...
                <v-text-field
                    ...
                    placeholder="Tên KH, SĐT, Tên sản phẩm..."
                    variant="outlined"
                    bg-color="white"
                    density="compact"
                    hide-details
                    ...
                    <tr class="data-row">
                        ...
                        <td class="data-cell">
                            <div class="d-flex align-center ga-3 my-2">
                                ...
                                <div class="d-flex flex-column text-truncate" style="max-width: 180px">
                                    <span
                                        class="text-subtitle-2 font-weight-medium text-slate-800 text-truncate"
                        ...
                        <td class="data-cell">
                            <div class="d-flex flex-column py-2">
                                ...
                                <span class="text-body-2 text-slate-700" style="white-space: pre-wrap; line-height: 1.4">{{
                                    item.noiDung
                                }}</span>
                        ...
                        <td class="data-cell text-center">
                            <v-chip
                                ...
                                >{{ getStatusChip(item.trangThai).text }}</v-chip
                            >
                        </td>
                        <td class="data-cell">
                        ...
                        <td class="data-cell text-center">
                            <div class="d-flex align-center justify-center ga-1">
                                <v-btn
                                    ...
                                    @click="openConfirm('Duyệt đánh giá', 'Bạn có chắc chắn muốn duyệt đánh giá này?', item.id, 'APPROVED')"
                                >
                                    <CheckIcon size="18" />
                                ...
                                <v-btn
                                    ...
                                    class="action-icon-btn"
                                    @click="
                                        openConfirm('Từ chối đánh giá', 'Bạn có chắc chắn muốn từ chối đánh giá này?', item.id, 'REJECTED')
                                    "
                                >
                                    <XIcon size="18" />
                                ...
                                <v-btn
                                    ...
                                    @click="
                                        openConfirm(
                                            'Đánh dấu Spam',
                                            'Bạn có chắc chắn muốn đánh dấu đánh giá này là SPAM?',
                                            item.id,
                                            'SPAM'
                                        )
                                    "
                                ...
                                <v-btn
                                    ...
                                    class="action-icon-btn"
                                    @click="
                                        openConfirm('Xóa đánh giá', 'Bạn có chắc chắn muốn xóa vĩnh viễn đánh giá này?', item.id, 'DELETE')
                                    "
                                >
                                    <TrashIcon size="18" />
