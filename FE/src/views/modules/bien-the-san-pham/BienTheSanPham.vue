      ...
      <AdminFilter title="Bộ lọc nâng cao" @refresh="resetFilters" :loading="loading">
        <v-col cols="12" md="2">
          ...
          <v-autocomplete v-model="selectedProductId"
            ...
            item-value="id" variant="outlined" density="compact" hide-details class="compact-input" />
        </v-col>
        <v-col cols="12" md="3">
          ...
          <v-text-field v-model="filters.keyword" placeholder="Mã SKU, màu, size..." prepend-inner-icon="mdi-magnify"
            variant="outlined" density="compact" hide-details clearable class="compact-input" />
        </v-col>
        <v-col cols="12" md="2">
        ...
        <template #after>
          <v-col cols="12" class="mt-4 pa-0">
            ...
            <v-range-slider :key="`${MIN_VARIANT_PRICE}-${dynamicMaxPrice}`" v-model="filters.khoangGia" :max="dynamicMaxPrice" :min="MIN_VARIANT_PRICE"
