        ...
        <div class="d-flex align-center mb-6">
            ...
            <div>
                <h1 class="text-h4 font-weight-bold">
                    {{ isDetailView ? 'Hồ sơ nhân viên' : isEditMode ? 'Cập nhật tài khoản' : 'Thêm nhân viên mới' }}
                </h1>
            </div>
            <v-spacer></v-spacer>
                        ...
                        <v-row>
                            <v-col cols="12" md="4">
                                <div class="text-subtitle-2 font-weight-bold mb-1 ml-1 text-dark">
                                    Mã nhân viên <span class="text-caption text-#2E4E8E">(Hệ thống tự tạo)</span>
                                </div>
                                <v-text-field
                            ...
                            <v-col cols="12">
                                ...
                                >
                                    <template #selection="{ item }">
                                        <v-chip :color="item.raw.color" size="small" variant="flat" class="px-4 font-weight-bold">{{
                                            item.title
                                        }}</v-chip>
                                    </template>
                                </v-select>
