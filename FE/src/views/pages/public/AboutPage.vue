                    ...
                    <v-row align="center" justify="center">
                        <v-col cols="12" md="5" class="pr-md-10 z-index-1">
                            ...
                            <p class="text-body-1 text-grey-darken-2 mb-6 leading-relaxed">
                                Được thành lập vào năm 2024, <strong class="text-black">AeroStride</strong> không chỉ là một thương hiệu bán lẻ giày thể thao, mà còn là nơi hội tụ của những tâm hồn đam mê dịch chuyển. Chúng tôi tin rằng mỗi bước đi đều mang một ý nghĩa riêng, và một đôi giày tốt sẽ là người bạn đồng hành hoàn hảo nhất.
                            </p>
                        ...
                        <v-col cols="12" md="7" class="mt-8 mt-md-0 z-index-1">
                            <div class="image-grid">
                                <div class="img-wrapper img-1 hover-scale">
                                    <v-img src="https://images.unsplash.com/photo-1556906781-9a412961c28c?auto=format&fit=crop&q=80&w=800" cover height="100%"></v-img>
                                </div>
                                <div class="img-wrapper img-2 hover-scale">
                                    <v-img src="https://images.unsplash.com/photo-1608231387042-66d1773070a5?auto=format&fit=crop&q=80&w=800" cover height="100%"></v-img>
                                </div>
                                <div class="img-wrapper img-3 hover-scale">
                                    <v-img src="https://images.unsplash.com/photo-1514989940723-e8e51635b782?auto=format&fit=crop&q=80&w=800" cover height="100%"></v-img>
                                </div>
                            </div>
                        </v-col>
                    </v-row>
...
.shape-3 { width: 200px; height: 200px; top: 30%; left: 60%; background: linear-gradient(45deg, rgba(255,255,255,0.1), transparent); animation-duration: 15s; }
