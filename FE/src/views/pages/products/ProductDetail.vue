                ...
                <v-col cols="12" md="6" lg="7">
                    <div class="sticky-info-panel px-md-8">
                        <div class="header-info mb-8">
                            <h1 class="product-title text-h4 font-weight-bold text-primary mb-1">{{ product.tenSanPham }}</h1>
                            <p class="product-cat text-subtitle-1 font-weight-medium text-grey-darken-1">
                                {{ product.tenThuongHieu }}
                            </p>
                            <div class="product-price mt-4 text-h5 font-weight-semibold text-primary">{{ formattedDisplayPrice }}</div>
                        </div>
                        ...
                        <div class="product-description mb-8">
                            ...
                            <div class="d-flex flex-wrap gap-4 mt-3">
                                <v-chip size="small" variant="flat" color="lightprimary"
                                    class="font-weight-medium text-primary product-badge-chip"><v-icon start size="14" color="primary">mdi-domain</v-icon> {{
                                    product.tenThuongHieu }}</v-chip>
                                <v-chip size="small" variant="flat" color="lightprimary"
                                    class="font-weight-medium text-primary product-badge-chip"><v-icon start size="14" color="primary">mdi-earth</v-icon> Xuất xứ: {{
                                    product.tenXuatXu }}</v-chip>
                                <v-chip size="small" variant="flat" color="lightprimary"
                                    class="font-weight-medium text-primary product-badge-chip"><v-icon start size="14" color="primary">mdi-barcode</v-icon> Mã: {{
                        ...
                        <div class="action-buttons d-flex flex-column gap-4">
                            ...
                            <v-btn v-if="authStore.isLoggedIn" block size="x-large" variant="outlined" rounded="pill" class="font-weight-medium py-6"
                        ...
                        <div class="shipping-returns mt-8">
                            <v-alert border="start"
                                icon="mdi-truck-fast-outline" class="rounded-lg shipping-returns-alert" elevation="0">
                            ...
                            <v-card variant="outlined" class="pa-4 rounded-xl border-grey-lighten-2 h-100">
                                <div class="d-flex align-center mb-3">
                                    <v-avatar color="indigo-lighten-4" size="40" class="mr-3">
                                        <span class="text-indigo-darken-4 font-weight-medium">{{ review.tenKhachHang ? review.tenKhachHang.charAt(0) : 'U' }}</span>
                                    </v-avatar>
                                    <div>
                                        <div class="font-weight-medium text-grey-darken-4">{{ review.tenKhachHang || 'Khách hàng ẩn danh' }}</div>
...
.shipping-returns-alert {
    background-color: #fffbeb !important; /* Pastel yellow background (amber-50) */
    border-color: #f59e0b !important; /* Warm yellow/amber border (amber-500) */
    color: #78350f !important; /* Elegant deep warm amber-brown text (amber-900) */
    ...
    .desc-text {
        color: #92400e !important; /* Slightly lighter body text (amber-800) */
        opacity: 0.95;
    }
}
