...
public class AdminNhanVienServiceImpl implements AdminNhanVienService {
    ...
    private void applyEntityFields(NhanVien nv, AdminNhanVienRequest req) {
        ...
        // Xử lý địa chỉ trực tiếp trong thực thể NhanVien
        ...
        if (req.getTinh() != null && req.getThanhPho() != null && req.getPhuongXa() != null) {
            String fullAddress = req.getDiaChiChiTiet() + ", " + req.getPhuongXa() + ", " + req.getThanhPho() + ", " + req.getTinh();
            nv.setDiaChi(fullAddress);
        }
    }
