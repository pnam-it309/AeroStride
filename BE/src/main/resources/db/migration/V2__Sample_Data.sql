...
INSERT IGNORE INTO nhan_vien (id, id_phan_quyen, ma_nhan_vien, ten_nhan_vien, email, sdt, ngay_sinh, gioi_tinh, ten_tai_khoan, mat_khau, hinh_anh,tinh,thanh_pho,phuong_xa,dia_chi_chi_tiet, xoa_mem, trang_thai, ngay_tao) VALUES
('nv1', 'pq1', 'NV001', 'Admin Hệ Thống', 'nickhunter3009@gmail.com', '0123456789', '1990-01-01', 1, 'admin', '{bcrypt}$2a$10$oocVPP6YqNyiSKxcgIZK4OgYXwGLfOVsShJcYSrUl55luGoRPr5rq', 'admin.jpg',"Hà Nội","Quận Nam Từ Liêm","Mỹ Đình 2","23 Lê Đức Thọ", 0, 0, 1711814400000),
('nv2', 'pq1', 'NV002', 'Admin Hệ Thống', 'phitrang082006@gmail.com', '0123456789', '1990-01-01', 0, 'admin1', '{bcrypt}$2a$10$oocVPP6YqNyiSKxcgIZK4OgYXwGLfOVsShJcYSrUl55luGoRPr5rq', 'admin.jpg',"Hà Nội","Hà Nội","Phường Hàng Bạc","12 Ngõ 23 Hàng Bạc", 0, 0, 1711814400000),
('nv3', 'pq1', 'NV003', 'Admin Hệ Thống', 't818721@gmail.com', '0123456789', '1990-01-01', 0, 'admin2', '{bcrypt}$2a$10$oocVPP6YqNyiSKxcgIZK4OgYXwGLfOVsShJcYSrUl55luGoRPr5rq', 'admin.jpg', "Hà Nội","Hà Nội","Phường Dịch Vọng","Số 45 Trần Thái Tông",0, 0, 1711814400000),
('nv4', 'pq1', 'NV004', 'Admin Hệ Thống', 'nguyenhuyducbg19062002@gmail.com', '0123456789', '1990-01-01', 1, 'admin3', '{bcrypt}$2a$10$oocVPP6YqNyiSKxcgIZK4OgYXwGLfOVsShJcYSrUl55luGoRPr5rq', 'admin.jpg',"Hồ Chí Minh", "TP. Thủ Đức","Phường Linh Trung","120 Võ Văn Ngân",0, 0, 1711814400000),
('nv5', 'pq1', 'NV005', 'Admin Hệ Thống', 'yent6969@gmail.com', '0123456789', '1990-01-01', 0, 'admin4', '{bcrypt}$2a$10$oocVPP6YqNyiSKxcgIZK4OgYXwGLfOVsShJcYSrUl55luGoRPr5rq', 'admin.jpg',"Hồ Chí Minh", "Quận 1","Phường Bến Nghé","88 Nguyễn Huệ",0, 0, 1711814400000),
...
INSERT IGNORE INTO dia_chi (id,id_khach_hang, ma_dia_chi, tinh, thanh_pho, phuong_xa, dia_chi_chi_tiet, ten_nguoi_nhan, sdt_nguoi_nhan, trang_thai,la_mac_dinh, ngay_tao) VALUES
...
INSERT IGNORE INTO xuat_xu (id, ma_xuat_xu, ten_xuat_xu, trang_thai, xoa_mem, ngay_tao) VALUES
...
INSERT IGNORE INTO muc_dich_chay (id, ma_muc_dich_chay, ten_muc_dich_chay, trang_thai, xoa_mem, ngay_tao) VALUES
...
INSERT IGNORE INTO co_giay (id, ma_co_giay, ten_co_giay, trang_thai, xoa_mem, ngay_tao) VALUES
...
INSERT IGNORE INTO chat_lieu (id, ma_chat_lieu, ten_chat_lieu, trang_thai, xoa_mem, ngay_tao) VALUES
...
INSERT IGNORE INTO de_giay (id, ma_de_giay, ten_de_giay, trang_thai, xoa_mem, ngay_tao) VALUES
...
INSERT IGNORE INTO kich_thuoc (id, ma_kich_thuoc, ten_kich_thuoc, gia_tri_kich_thuoc, trang_thai, xoa_mem, ngay_tao) VALUES
...
INSERT IGNORE INTO mau_sac (id, ma_mau_sac, ten_mau_sac, ma_mau_hex, trang_thai, xoa_mem, ngay_tao) VALUES
...
INSERT IGNORE INTO anh_chi_tiet_san_pham (id, id_chi_tiet_san_pham, duong_dan_anh, hinh_anh_dai_dien, mo_ta, xoa_mem, trang_thai, ngay_tao) VALUES
...
INSERT IGNORE INTO dot_giam_gia (id, ma_dot_giam_gia, ten_dot_giam_gia, loai_giam_gia, so_tien_giam, dieu_kien_giam_gia, ngay_bat_dau, ngay_ket_thuc, muc_uu_tien, trang_thai, ngay_tao) VALUES
...
INSERT IGNORE INTO chi_tiet_dot_giam_gia (id, id_dot_giam_gia, id_chi_tiet_san_pham, gia_tri_giam, trang_thai, ngay_tao) VALUES
...
INSERT IGNORE INTO phieu_giam_gia (id, ma_phieu_giam_gia, ten_phieu, loai_phieu, phan_tram_giam_gia, so_tien_giam, so_luong, don_hang_toi_thieu, giam_toi_da, ngay_bat_dau, ngay_ket_thuc, ghi_chu, trang_thai, ngay_tao) VALUES
...
INSERT IGNORE INTO phieu_giam_gia_ca_nhan (id, id_khach_hang, id_phieu_giam_gia, ma_phieu_giam_gia_ca_nhan, ngay_nhan, da_su_dung, ngay_su_dung, xoa_mem, trang_thai, ngay_tao) VALUES
...
INSERT IGNORE INTO phuong_thuc_thanh_toan (id, ma_phuong_thuc_thanh_toan, ten_phuong_thuc_thanh_toan, trang_thai, ngay_tao) VALUES
...
INSERT IGNORE INTO giao_dich_thanh_toan (id, id_hoa_don, id_phuong_thuc_thanh_toan, ma_giao_dich_thanh_toan, so_tien, loai_giao_dich, ma_giao_dich_ngoai, ma_tham_chieu, duong_dan_thanh_toan, du_lieu_qr, thoi_gian_het_han, du_lieu_phan_hoi, ngay_tao, trang_thai, ghi_chu) VALUES
